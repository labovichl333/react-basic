...
const PostList = () => {
    ...
    const debouncedGetPosts = useDebounce(postService.getPosts, 500);
    ...
    useEffect(() => {
        if (!isFirstRender.current) {
            debouncedGetPosts(Object.fromEntries(searchParams.entries()), response.page, limit, setResponse, true)
        }
